...
import { ChecklistKebersihanTab } from "./ChecklistKebersihanTab";
...
export function SalesManagement() {
  const [activeTab, setActiveTab] = useState<"data" | "checklist">("data");
  ...
  return (
    <div className="p-8">
      ...
      <div className="flex gap-1 mb-6 border-b border-[rgba(140,172,214,0.35)]">
        {[
          { id: "data", label: "Data Sales" },
          { id: "checklist", label: "Checklist Kebersihan" },
        ].map((tab) => (
          <button
            key={tab.id}
            onClick={() => setActiveTab(tab.id as "data" | "checklist")}
